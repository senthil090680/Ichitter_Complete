			...
			<?php include ('common/side_navigation.php');?>		  
				...
				<div id="mainupload">
					...
					<div class="ucipublishedtxt">
							 <div id="searchupload">
							 <form action="create_gallery.php" name="galleryform" method="POST" onsubmit="return checkgalleryname();">						
									...
									<input type="submit" name="submit" value="Create Album" id="createAlbum">
							</form>		
							</div>				
					</div> 
