...
function chatWith(chatuser,chatusername) {
	if(chatusername == 0) {
		//alert(chatusername+"789");
		createChatBox(chatuser,0,0);
	}
	else {
		//alert(chatusername+"456");
		createChatBox(chatuser,0,chatusername);
	}
	$("#chatbox_"+chatuser+" .chatboxtextarea").focus();
}

function createChatBox(chatboxtitle,minimizeChatBox,chatuserone) {
	...
	if(chatuserone == 0) {
		var chattitlename = $("#udetails_"+chatboxtitle).val();
		//alert(chattitlename+"124");
	}
	else if(chatuserone !='' && chatuserone !=0)
	{
		var chattitlename = chatuserone;
		//alert(chattitlename+"123");
	}
		...
		$.each(data.items, function(i,item){
			if (item)	{ // fix strange ie bug
				...
				if (item.s == 2) {
                	...
                	chattitlename = $("#udetails_"+item.f).val();				
...
function checkChatBoxInputKey(event,chatboxtextarea,chatboxtitle) {
	...
	if(event.keyCode == 13 && event.shiftKey == 0)  {
		...
		if (message != '') {
			chattitlename = $("#udetails_"+username).val();
