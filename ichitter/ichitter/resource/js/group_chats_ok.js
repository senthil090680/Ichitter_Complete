...
var glovar = 0;
	$("#openchat").click(function(){
		...
		$.post(posturl, { user_id: user_ids, group_id : group_ids, get_chats: 'get_chats'},
		   function(data) {
		   if(data != ""){
				...
				.html('<div id="menu" class="menugrp"><p class="welcome"><b>'+group_ids+'<b></p><p class="logout"><a id="exit" class="exit" onclick="javascript:return closeGroupChatBox(this,\''+group_ids+'\');"><b>X</b></a></p><div style="clear:both"></div></div><div id="chatbox" class="chatbox" style="display:block;">'+data+'</div><div style="padding-top:280px;"><input type="hidden" value="glovar'+group_ids+'\" name="glovar'+group_ids+'\" id="glovar'+group_ids+'\"/><textarea class="chatboxtextarea" onkeydown="javascript:return checkGroupChatBoxInputKey(event,this,\''+group_ids+'\');"></textarea></div>').appendTo($( "body" ));
						...
						$.post(posturl, { user_id: user_ids, group_id : chatgroup_id, get_chats: 'get_chats'},
						   function(data) {
							   if(data != "") {
									...
									if(((checkchat != "block") || (typeof checkchat === "undefined")) && (checkopen == '' || checkopen == null)) {
										$(" <div />" ).attr("id","wrapperChat"+chatgroup_id)
										.addClass("wrapperChat")
										.html('<div id="menu" class="menugrp"><p class="welcome"><b>'+groupname+'<b></p><p class="logout"><a id="exit" class="exit" onclick="javascript:return closeGroupChatBox(this,\''+chatgroup_id+'\');"><b>X</b></a></p><div style="clear:both"></div></div><div id="chatbox" class="chatbox" style="display:block;">'+data+'</div><div style="padding-top:280px;"><input type="hidden" value="glovar'+chatgroup_id+'\" name="glovar'+chatgroup_id+'\" id="glovar'+chatgroup_id+'\"/><textarea class="chatboxtextarea1" onkeydown="javascript:return checkGroupChatBoxInputKey(event,this,\''+chatgroup_id+'\');"></textarea></div>').appendTo($( "body" ));
										...
										$("#wrapperChat"+chatgroup_id).css("float","right");
										$("#wrapperChat"+chatgroup_id+" .chatbox").html(data);
									}									
								}
						});
						checkchatmsg = 0;
