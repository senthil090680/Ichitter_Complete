...
function isEmailAddr(email)
{
  ...
  if (oRegExp.test(tri(email)))
	...
	function validate_songRequest()
	{
		...
		if((document.getElementById("txtmovie").value) == "" || (document.getElementById("txtmovie").value) == "Movie")
		{
			msg = "Movie Name\n" + msg;
			focus = "txtmovie";
		}
		if((document.getElementById("ddlprogram").value) == "")
		{
			msg = "Program Name\n" + msg;
			focus = "ddlprogram";
		}
		if((document.getElementById("txtmobile").value) == "" || (document.getElementById("txtmobile").value) == "Your Mobile")
		{
			msg = "Your Mobile\n" + msg;
			focus = "txtmobile";
		}
		...
		{
            document.frmsongrequest.action = "songUpdate.php";
			document.frmsongrequest.method = "POST";
			document.frmsongrequest.submit();
			return true;
		}
	}
	function validate_advertisersRequest()
	{
		var msg = "";
		var focus = "";
		...
		if((document.getElementById("chkRequestType").value) == "")
		{
			msg = "Request Type\n" + msg;
			focus = "chkRequestType";
		}
		...
		{
			if(!IsNumericPhone((document.getElementById("txtContact").value)))
			{
		...
		{
            document.frmadvertiser.action = "advertisersUpdate.php";
			document.frmadvertiser.method = "POST";
...
function val_post() {
	...
	if(tDesc.trim() == "") {
		...
		$("#txtDesc").focus();
		return false;
	}else if((gtype != 'I') && (gtype != 'V')) {
		alert("Please choose graphic type");
		//$('input[name=gtype]', '#frmaddpost').focus();
		return false;
	}else {
		document.frmaddpost.action = "posting_process.php";
	    document.frmaddpost.method = "POST";
