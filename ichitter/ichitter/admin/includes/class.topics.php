...
class topics {
	...
	function get_alltopics($limit = null) {
		$this->QUERY = "select topics_id,title, CASE WHEN LENGTH(description) >30 THEN CONCAT(substr(description, 1, 30 ) , '...' ) ELSE description END , image, created_date from " . TOPICS . ' ORDER BY topics_id DESC  limit ' . $limit;
