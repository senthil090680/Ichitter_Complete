									...
									<tr>
										<td height="110">
											...
											while ($row = mysql_fetch_row($result)) {
												...
												echo "<td width='8%' style='padding-left:5px; background-color:#f4f4f4;' class='content' align='center'><a href='editsubtopics.php?editaction=edit&id=$row[0]'><img src='images/but-Edit.png' border='0'></a></td>";
												echo "<td width='8%' style='padding-left:5px; background-color:#f4f4f4;' class='content' align='center'><a href='#' onclick='return deletesubtopics($row[0]);'><img src='images/but-Delete.png' border='0'></a></td></tr>\n";
											}
											echo "</table><br>";
											?>
										</td>
