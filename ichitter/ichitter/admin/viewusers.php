									...
									<tr>
										<td height="400">
											...
											echo "<tr>
													...
													<td class='admintitle'>Duration</td>
											...
											while ($row = mysql_fetch_array($result)) {
												...
												echo "<td width='25%' style='padding:10px; background-color:#f4f4f4;' class='content'>" . $row['registered_on'] . "</td>";
												echo "<td width='25%' style='padding:10px; background-color:#f4f4f4;' class='content'>" . $row['logintime'] . "</td>";
												echo "<td width='25%' style='padding:10px; background-color:#f4f4f4;' class='content'>" . $row['log_duration'] . "</td>";
												$active = 'Activate';
												$dos = '0';
												$cls = 'acts';
												$icon = "inactive.png";
