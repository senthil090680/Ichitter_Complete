...
include_once 'library/errMessages.php';
$msg = "";
$postid = "";
$topicsid = "";
$subtopicid = "";
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
	    ...
	    var subtopicid = <?php echo $subtopicid; ?>;
	    //var QSTRING = "<?php echo PARAM_TOPICID . '=' . $topicsid ?>";
	...
	<div id="container">
		...
		<form name="frmMarks" id="frmMarks" action="posting_process.php">
		    ...
		    <input type="hidden" name="<?php echo PARAM_CURRENT_PAGE; ?>" id="<?php echo PARAM_CURRENT_PAGE; ?>" value="fh" />
