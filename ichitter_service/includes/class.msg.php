...
class Msg extends commonGeneric {
	...
	public function get_indivitual_msg($data){
		...
		$sql = "SELECT *,(SELECT DATE_FORMAT(msg_sent_time, '%M %d')) as msg_sent_time,TIME_TO_SEC((SELECT TIMEDIFF(NOW(),msg_sent_time))) as msgsenttime FROM tbl_msg where 
